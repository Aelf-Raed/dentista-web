    ...
    <div class="mask mascara">
        <div class="container d-flex align-items-center justify-content-center text-center h-100">
            <div class="text-light lead font-monospace mt-5 pt-5">
                <h1 class="mb-3 display-5 pt-3 fw-bold" data-aos="fade-right">Contáctanos</h1>
                <h5 class="mb-4 fw-bold" data-aos="fade-left"><em>¿Ya te deciste?, Agenda tu cita!</em></h5>
                <br>
            </div>
        </div>
    </div>
...
<div class="container my-5">
    <section id="contact">
        <div class="row text-center">
            <div class="col"></div>
            <div class="col-md-5 mb-5 border-end" data-aos="fade-down">
                <h4 class="fw-bold mb-5 title-color"><i class="fas fa-map-marker-alt"></i> Dirección</h4>
            ...
            <div class="col-md-5 mb-5 border-start" data-aos="fade-down">
                <h4 class="fw-bold mb-5 title-color"><i class="far fa-clock"></i> Horarios</h4>
